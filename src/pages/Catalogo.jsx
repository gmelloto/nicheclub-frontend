  ...
  return (
    <div style={{ background: S.black, color: S.text, fontFamily: "'Inter', sans-serif", overflowX: 'hidden' }}>
      ...
      <div className="hero-section" style={{
        ...
        display: 'flex', overflow: 'hidden', background: '#f5f3ef',
      }}>
        ...
        <div style={{ position: 'absolute', inset: 0, background: 'rgba(245,243,239,0.55)' }} />
        ...
        <div style={{
          ...
          <p style={{ fontSize: 16, color: '#444', lineHeight: 1.7, maxWidth: 360 }}>
